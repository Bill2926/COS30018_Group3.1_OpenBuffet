...
if os.path.exists(model_file):
    ...
    # This is our first hidden layer which defines the input shape.
    ...
    # loss='mean_absolute_error'/'huber'/'cosine_similarity'/...
    # Note: 'huber_loss' was renamed to 'huber' in Keras 2.x+
